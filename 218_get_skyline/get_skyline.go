/*
 * @Date: 2021-07-13 08:36:16
 * @Author: Mengsen Wang
 * @LastEditors: Mengsen Wang
 * @LastEditTime: 2021-07-13 08:58:25
 */
...
func main() {
	...
	}
	{
		...
		assert(getSkyline(buildings), [][]int{{2, 10}, {3, 15}, {7, 12}, {12, 0}, {15, 10}, {20, 8}, {24, 0}})
	}
	{
		buildings := [][]int{{0, 2, 3}, {2, 5, 3}}
		assert(getSkyline(buildings), [][]int{{0, 3}, {5, 0}})
	}
}
