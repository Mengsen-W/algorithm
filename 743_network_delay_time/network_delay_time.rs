/*
 * @Date: 2021-08-02 15:26:27
 * @Author: Mengsen Wang
 * @LastEditors: Mengsen Wang
 * @LastEditTime: 2021-08-02 16:05:11
 */
...
fn main() {
    {
        ...
        let k = 2;
        let ans = 2;
        assert_eq!(network_delay_time_dijkstra(times.clone(), n, k), ans);
        assert_eq!(network_delay_time_floyd(times.clone(), n, k), ans);
    }
    {
