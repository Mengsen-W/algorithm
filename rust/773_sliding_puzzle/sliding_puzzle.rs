/*
 * @Date: 2021-06-26 09:57:49
 * @Author: Mengsen Wang
 * @LastEditors: Mengsen Wang
 * @LastEditTime: 2021-06-26 15:25:49
 */
...
fn main() {
    {
        ...
        assert_eq!(sliding_puzzle(board), 1);
    }
    {
    ...
    }
    {
        ...
        assert_eq!(sliding_puzzle(board), 5);
    }
    {
        let board = vec![vec![3, 2, 4], vec![1, 5, 0]];
        assert_eq!(sliding_puzzle(board), 14);
    }
}
