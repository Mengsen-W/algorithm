...
fn main() {
    ...
    assert_eq!(my_calendar_two.book(10, 20), true);
    assert_eq!(my_calendar_two.book(50, 60), true);
    assert_eq!(my_calendar_two.book(10, 40), true);
    assert_eq!(my_calendar_two.book(5, 15), false);
    assert_eq!(my_calendar_two.book(5, 10), true);
    assert_eq!(my_calendar_two.book(25, 55), true);
}
