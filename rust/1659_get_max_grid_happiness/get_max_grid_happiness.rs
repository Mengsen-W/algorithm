 ...
 * @FilePath: /algorithm/rust/1659_get_max_grid_happiness/get_max_grid_happiness.rs
 */
...
impl Solution {
    ...
    fn dfs(
        ...
        if dp[p as usize][in_ as usize][ex as usize][mask_in as usize][mask_ex as usize] > 0 {
            return dp[p as usize][in_ as usize][ex as usize][mask_in as usize][mask_ex as usize]
                - 1;
        }
