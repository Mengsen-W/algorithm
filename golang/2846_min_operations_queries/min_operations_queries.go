 ...
 * @FilePath: /algorithm/golang/2846_min_operations_queries/min_operations_queries.go
 */
...
func main() {
	...
	for index, test := range tests {
		assert.Equal(&testing.T{}, test.ans, minOperationsQueries(test.n, test.edges, test.queries), index)
	}
}
