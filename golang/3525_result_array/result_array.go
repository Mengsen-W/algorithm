...
func main() {
	tests := []struct{
		...
		{[]int{1, 2, 3, 4, 5}, 3, [][]int{{2, 2, 0, 2}, {3, 3, 3, 0}, {0, 1, 0, 1}}, []int{2, 2, 2}},
		{[]int{1, 2, 4, 8, 16, 32}, 4, [][]int{{0, 2, 0, 2}, {0, 2, 0, 1}}, []int{1, 0}},
		{[]int{1,1,2,1,1},2,[][]int{{2,1,0,1}},[]int{5}},
	}

	for index, test := range tests {
		assert.Equal(&testing.T{}, test.expected, resultArray(test.nums, test.k, test.queries), index)
	}
}
