 ...
 * @FilePath: /algorithm/golang/466_get_max_repetitions/get_max_repetitions.go
 */
...
func main() {
	...
	for index, test := range tests {
		fmt.Println(getMaxRepetitions(test.s1, test.n1, test.s2, test.n2))
		assert.Equal(&testing.T{}, test.ans, getMaxRepetitions(test.s1, test.n1, test.s2, test.n2), index)
	}
}
