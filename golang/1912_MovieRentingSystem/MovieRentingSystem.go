...
func main() {
	movieRentingSystem := Constructor(3, [][]int{{0, 1, 5}, {0, 2, 6}, {0, 3, 7}, {1, 1, 4}, {1, 2, 7}, {2, 1, 5}})
	assert.Equal(&testing.T{}, movieRentingSystem.Search(1), []int{1, 0, 2})
	movieRentingSystem.Rent(0, 1)
	movieRentingSystem.Rent(1, 2)
	assert.Equal(&testing.T{}, movieRentingSystem.Report(), [][]int{{0, 1}, {1, 2}})
	movieRentingSystem.Drop(1, 2)
	assert.Equal(&testing.T{}, movieRentingSystem.Search(2), []int{0, 1})
}
