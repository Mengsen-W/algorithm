/*
 * @Date: 2022-01-11 00:42:57
 * @Author: Mengsen Wang
 * @LastEditors: Mengsen Wang
 * @LastEditTime: 2022-01-11 00:53:05
 */
...
func main() {
	...
	assert(!isEscapePossible([][]int{{0, 1}, {1, 0}}, []int{0, 0}, []int{0, 2}))
	assert(isEscapePossible([][]int{}, []int{0, 0}, []int{999999, 999999}))
