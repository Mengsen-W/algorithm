...
func main() {
	tests := []struct {
		...
		{[]int{2, 1, 3, 5, 6}, 5, 2, []int{8, 4, 6, 5, 6}},
		{[]int{100000, 2000}, 2, 1000000, []int{999999307, 999999993}},
	}

	for index, test := range tests {
		assert.Equal(&testing.T{}, test.ans, getFinalState(test.nums, test.k, test.multiplier), index)
	}
}
