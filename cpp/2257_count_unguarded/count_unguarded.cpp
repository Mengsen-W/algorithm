...
int main() {
  vector<tuple<int, int, vector<vector<int>>, vector<vector<int>>, int>> tests{
      {4, 6, {{0, 0}, {1, 1}, {2, 3}}, {{0, 1}, {2, 2}, {1, 4}}, 7},
      {3, 3, {{1, 1}}, {{0, 1}, {1, 0}, {2, 1}, {1, 2}}, 4},
  };

  for (auto& [m, n, guard, walls, ans] : tests) {
    assert(Solution().countUnguarded(m, n, guard, walls) == ans);
  }
}
