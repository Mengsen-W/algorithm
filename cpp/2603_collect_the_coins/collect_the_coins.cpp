 ...
 * @FilePath: /algorithm/cpp/2603_collect_the_coins/collect_the_coins.cpp
 */
...
int main() {
  ...
  for (auto& [coins, edges, expected] : tests) {
    assert(Solution().collectTheCoins(coins, edges) == expected);
  }
}