/*
 * @Date: 2022-04-23 09:48:58
 * @Author: Mengsen Wang
 * @LastEditors: Mengsen Wang
 * @LastEditTime: 2022-04-23 10:19:01
 * @FilePath: /algorithm/587_outer_trees/outer_trees.cpp
 */
...
int main() {
  assert((Solution().outerTrees(vector<vector<int>>{{1, 1}, {2, 2}, {2, 0}, {2, 4}, {3, 3}, {4, 2}}) ==
          vector<vector<int>>{{1, 1}, {2, 0}, {4, 2}, {3, 3}, {2, 4}}));
  assert((Solution().outerTrees(vector<vector<int>>{{1, 2}, {2, 2}, {4, 2}}) ==
          vector<vector<int>>{{1, 2}, {2, 2}, {4, 2}}));
}