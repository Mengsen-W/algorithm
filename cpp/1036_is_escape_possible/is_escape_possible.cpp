/*
 * @Date: 2022-01-11 00:42:51
 * @Author: Mengsen Wang
 * @LastEditors: Mengsen Wang
 * @LastEditTime: 2022-01-11 00:50:26
 */
...
int main() {
  assert(!Solution().isEscapePossible({{0, 1}, {1, 0}}, {0, 0}, {0, 2}));
  assert(Solution().isEscapePossible({}, {0, 0}, {999999, 999999}));
}