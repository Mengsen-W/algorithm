...
int main() {
  vector<tuple<vector<vector<char>>, int, int, char, bool>> tests{
      {{{'.', '.', '.', 'B', '.', '.', '.', '.'},
        {'.', '.', '.', 'W', '.', '.', '.', '.'},
        {'.', '.', '.', 'W', '.', '.', '.', '.'},
        {'.', '.', '.', 'W', '.', '.', '.', '.'},
  ...
  for (auto& [board, rMove, cMove, color, ans] : tests) {
    assert(Solution().checkMove(board, rMove, cMove, color) == ans);
  }
}