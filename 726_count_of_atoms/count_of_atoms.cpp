/*
 * @Date: 2021-07-05 08:37:26
 * @Author: Mengsen Wang
 * @LastEditors: Mengsen Wang
 * @LastEditTime: 2021-07-05 08:43:10
 */
...
int main() {
  {
    string formula = "H2O";
    assert(countOfAtoms(formula) == "H2O");
  }
  {
    string formula = "Mg(OH)2";
    assert(countOfAtoms(formula) == "H2MgO2");
  }
  {
    string formula = "K4(ON(SO3)2)2";
    assert(countOfAtoms(formula) == "K4N2O14S4");
  }
}