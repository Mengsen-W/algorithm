 ...
 * @LastEditTime: 2022-02-08 00:38:55
 */
...
int main() {
  assert((Solution().gridIllumination(5, {{0, 0}, {4, 4}}, {{1, 1}, {1, 0}}) ==
          vector<int>{1, 0}));
  assert((Solution().gridIllumination(5, {{0, 0}, {4, 4}}, {{1, 1}, {1, 1}}) ==
          vector<int>{1, 1}));
  assert((Solution().gridIllumination(5, {{0, 0}, {0, 4}},
                                      {{0, 4}, {0, 1}, {1, 4}}) ==
          vector<int>{1, 1, 0}));
}